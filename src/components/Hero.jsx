...
export const Hero = () => {
  return (
    <div className="flex flex-row flex-wrap sm:flex-col md:flex-row sm:gap-2  w-full h-full bg-gradient-to-r from-indigo-900 to-indigo-600 text-white py-20 md:px-20 xl:px-36 sm:px-10">
      <div className="flex flex-col flex-1 p-10 justify-center ">
        <p className="text-9xl sm:text-3xl font-bold ">
        ...
        <div className="flex">
          <p className="text-9xl sm:text-3xl font-bold ">at Skill Up</p>
